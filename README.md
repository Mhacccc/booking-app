...
├── .cursorrules         # Automated instructions and coding rules for IDE/AI agents
└── CONTRIBUTING.md      # Development guides, branching, and commit conventions
```
...
### 2. Environment Setup
Navigate to the `/api` directory and copy the template:
```bash
cd api
cp .env.example .env
```
